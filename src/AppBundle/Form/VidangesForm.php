...
class VidangesForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
						->add('dateDeVidange', DateType::class)
						->add('KiloDebut', TextType::class,['attr'=>['placeholder'=>'kilometrage debut'] ])
						->add('KiloFin', TextType::class,['attr'=>['placeholder'=>'kilometrag fond'] ])
						->add('vehicules', EntityType::class, array(
						'class'=>'AppBundle\Entity\Vehicules',
						'choice_label'=>'immatriculation',
						'expanded'=>false,
						'multiple'=>false))
						->add('save', SubmitType::class, array('label' => 'Enregistrer le vidange'))
        ;
    }
public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => Vidanges::class,
        ));
    }
